function [Population,Fitness] = Environmental_Selection(Population,N,MOP,r,C,W)
...
%--------------------------------------------------------------------------
    ...
    objs = MOP.CalV(repair1(MOP,r,C,W,Population));
...
% Select part of the solutions by truncation
    ...
    while sum(Del) < K
        Remain   = find(~Del);
        Temp     = sort(Distance1(Remain,Remain)+Distance2(Remain,Remain)+Distance3(Remain,Remain),2);
        [~,Rank] = sortrows(Temp);
